...
# --- 4. CONTROLLO SE LA TAPPA È IN CORSO ---
...
# --- 5. LOGICA TAB (Solo per id_type_race != 3) ---
if sel_gara['type'] != 3:
    tab_ins, tab_riep = st.tabs(["✍️ Inserimento Pick", "📊 Riepilogo Pick"])
else:
    # Per le classiche, usiamo un "contenitore" finto per mantenere la logica coerente
...
if tab_riep:
    with tab_riep:
        ...
        try:
            ...
            st.error(f"Errore caricamento riepilogo: {e}")
